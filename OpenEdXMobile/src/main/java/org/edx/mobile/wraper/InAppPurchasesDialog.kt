...
class InAppPurchasesDialog @Inject constructor(
    ...
    fun showSDNDialog(fragment: Fragment, onPositiveClick: DialogInterface.OnClickListener) {
        AlertDialogFragment.newInstance(
            ...
            { _, _ ->
                iapAnalytics.trackIAPEvent(
                    eventName = Analytics.Events.IAP_SDN_PROMPT_ACTION,
                    actionTaken = Analytics.Values.ACTION_REJECT
                )
            },
            ...
            { dialog, which ->
                ...
                iapAnalytics.trackIAPEvent(
                    eventName = Analytics.Events.IAP_SDN_PROMPT_ACTION,
                    actionTaken = Analytics.Values.ACTION_CONFIRM
                )
            },
            false
